...
export function CommunicationForm({
  ...
  const { communicationOptions, communicationOptionsLoading } = useSelector(
    (state) => state.communications
  );

  const communicationType = communicationOptions.communicationType || [];
  const category = communicationOptions.category || [];
  const initiatedBy = communicationOptions.initiatedBy || [];
  const statuses = communicationOptions.status || [];
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <select
              disabled={communicationOptionsLoading}
